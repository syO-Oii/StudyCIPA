...
<link rel="stylesheet"href="style/addPlayer.css">
</head>
<body>
...
<a href = "Main.jsp">목록으로 돌아가기</a>
	<table>
		...
		<tr>
			<td>투/타</td>
			<td><input type="radio" name = "pos" id = "Hitter" value = "H" /> 타자
		...
		<tr>
			<td>포지션</td>
			<td><select id = "job" name = "dpos" size = "1">
		...
		<tr><td></td><td><input type = "submit" value = "확인" />
